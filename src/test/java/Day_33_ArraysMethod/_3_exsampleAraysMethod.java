...
public class _3_exsampleAraysMethod {

    public static void main(String[] args) {
        //aabbcaabbccddeaatdfdxc
        String abc ="aabbcaabbccddeaatdfdxc";
        //char ile belirli bir dizi olusturduk
        char[] karekterleri= new char[args.length];
        //karakterleri alip tek tek dizi icerisinde element haline getirecegiz.
        // Sonra Arrays.sort ile siralayip sayma islemi yapariz
