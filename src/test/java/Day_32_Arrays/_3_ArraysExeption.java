...
//        isimler[4]="Ayse";//olmayan bir element deger atadik
//        System.out.println("isimler = " + isimler[4]);
        ...
        double[] ranges={1.4,3.2,4.6,6.33,1.2};
        ...
        for (int i = 0; i < evetVeHayirlar.length; i++) {
            System.out.println("evetVeHayirlar = " + evetVeHayirlar[i]);
