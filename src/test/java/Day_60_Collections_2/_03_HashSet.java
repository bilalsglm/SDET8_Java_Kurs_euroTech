...
public class _03_HashSet {
    public static void main(String[] args) {
        ...
        HashSet<Integer> h1;//Bu sadece int degerleri element olarak alir

        HashSet<Object> hdObject=new HashSet<>();//herhangi bir obje element olarak atanabilir
        ...
        //Yazdirma islemi -->int olarak e forEach ile yazdirdik
        for (int e : h3) {
