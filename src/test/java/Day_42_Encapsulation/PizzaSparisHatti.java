...
public class PizzaSparisHatti {
    ...
    public static void islemeAl(ArrayList<Pizza> siparisler){
        ...
        for (Pizza p : siparisler) {
            switch (p.buyukluk){
                ...
                case MIDIUM:mikMeidum+= p.miktar;break;
                case LARGE:mikLarge+= p.miktar;break;
            }

        }
        System.out.println("Small pizza "+mikSmall+" adet");
        System.out.println("Midium pizza "+mikMeidum+" adet");
    ...
    public static void siparisAl(int secim, ArrayList<Pizza> siparisler){
        ...
        if(secim<=4){
            ...
            switch (secim){
                case 1:siparisEdilenPizza=new Pizza(miktar,PizzaSize.SMALL);break;
                case 2:siparisEdilenPizza=new Pizza(miktar,PizzaSize.MIDIUM);break;
                case 3:siparisEdilenPizza=new Pizza(miktar,PizzaSize.LARGE);break;
            }
