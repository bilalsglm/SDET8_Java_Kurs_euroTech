...
public class _6_wrapperValueParse {
    public static void main(String[] args) {
        ...
        //ValueOf obje nin degerini verir.Obje nin burada deegi var,hala class objesi olarak bir tamsayi
        ...
        number=number+5;
        System.out.println("PrseInt den sonra number eklendi= "+number);//2028
